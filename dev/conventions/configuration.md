...
must never fall back to passthrough. The current implementation proposal rejects
...
for the review-stage contract and tracked changes; this is not release adoption.
